export default [
  ...
  },
  {
    constant: true,
    inputs: [{ internalType: 'bytes32', name: '', type: 'bytes32' }],
    name: 'currencyByExternal',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
    signature: '0xeedb421e',
  },
  {
    constant: true,
    inputs: [{ internalType: 'bytes32', name: '', type: 'bytes32' }],
  ...
  },
  {
    ...
    name: 'setCurrencyToExternalAggregator',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0xbecb1954',
  },
  {
    constant: false,
    inputs: [{ internalType: 'address', name: '_aggregator', type: 'address' }],
    name: 'setExternalRateAggregator',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0x40ba3791',
  },
  {
    constant: false,
    inputs: [
