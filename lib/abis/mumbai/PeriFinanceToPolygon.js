export default [
  ...
  },
  {
    ...
    inputs: [
      ...
      { internalType: 'bool', name: '_isIssue', type: 'bool' },
    ],
  ...
  },
  {
    constant: true,
    inputs: [],
    name: 'inflationMinter',
    outputs: [{ internalType: 'address', name: '', type: 'address' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
    signature: '0x321ea17c',
  },
  {
    constant: false,
    inputs: [
      {
        internalType: 'uint256',
        name: '_networkDebtShare',
        type: 'uint256',
      },
    ],
    name: 'inflationalMint',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0xb13c7e19',
  },
  {
    constant: true,
    inputs: [],
  ...
  },
  {
    ...
    inputs: [
      {
        internalType: 'address',
        name: '_newinflationMinter',
        type: 'address',
      },
    ],
    name: 'setinflationMinter',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0x1c12b566',
  },
  {
    constant: false,
    inputs: [{ internalType: 'bytes32', name: 'currencyKey', type: 'bytes32' }],
