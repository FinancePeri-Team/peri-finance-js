export default [
  ...
  {
    constant: false,
    inputs: [{ name: '_periFinance', type: 'address' }],
    name: 'setPeriFinance',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ name: '_owner', type: 'address' }, { name: '_periFinance', type: 'address' }],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'newPeriFinance', type: 'address' }],
