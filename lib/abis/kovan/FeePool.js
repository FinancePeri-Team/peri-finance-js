export default [
  ...
  },
  {
    ...
    type: 'event',
    signature: '0x7c5f7fb6526b0a8616698d2eb9ae98c6784156340c80c4587cdb5cd9523f2536',
  },
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    stateMutability: 'view',
    type: 'function',
    signature: '0xbfaa8cca',
  },
  {
    constant: true,
    inputs: [],
    name: 'PERI_REWARD_RATIO',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
    signature: '0x7fcbadf8',
  },
  {
    constant: true,
    inputs: [],
    name: 'USDC_REWARD_RATIO',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
    signature: '0x5d71b6ae',
  },
  {
    constant: false,
    inputs: [],
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'bool', name: 'periFeesClaimable', type: 'bool' },
      { internalType: 'bool', name: 'usdcFeesClaimable', type: 'bool' },
    ],
    payable: false,
    stateMutability: 'view',
    type: 'function',
