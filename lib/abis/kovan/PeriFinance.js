export default [ { inputs:
  ...
  { anonymous: false,
    ...
    type: 'event',
    signature:
     '0x0053a2d0a74627ad6d346bc05ca92631666b0cec11ac95505fe1f048f3845e11' },
  { anonymous: false,
    inputs:
     [ { indexed: false,
         internalType: 'address',
  ...
  { anonymous: false,
    ...
    type: 'event',
    signature:
     '0x4a0ae13ecb43c31fb105d00f9bb9bb573465fe44c0e86d51dc9b6c36090f6e28' },
  { anonymous: false,
    inputs:
     [ { indexed: false,
         internalType: 'address',
  ...
  { constant: true,
    ...
    outputs:
     [ { internalType: 'contract IPynth', name: '', type: 'address' } ],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  { constant: false,
    ...
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0x54037f76' },
  { constant: false,
    inputs: [],
    name: 'burnPynthsToTargetAndUnstakeUSDCToTarget',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0x4e15f559' },
  { constant: false,
    inputs:
     [ { internalType: 'address',
         name: 'burnForAddress',
  ...
  { constant: true,
    ...
    stateMutability: 'view',
    type: 'function',
    signature: '0x6b9db4e6' },
  { constant: true,
    inputs:
     [ { internalType: 'address', name: 'account', type: 'address' } ],
    name: 'getLockCalculation',
    outputs:
     [ { internalType: 'uint256', name: '', type: 'uint256' },
       { internalType: 'uint256', name: '', type: 'uint256' } ],
    payable: false,
  ...
  { constant: true,
    ...
    outputs:
     [ { internalType: 'address', name: 'account', type: 'address' },
       ...
       { internalType: 'uint256', name: 'unitTime', type: 'uint256' },
       { internalType: 'uint256', name: 'endTime', type: 'uint256' } ],
    payable: false,
    stateMutability: 'view',
    type: 'function',
    signature: '0x37580f90' },
  { constant: true,
    inputs:
     [ { internalType: 'address', name: 'account', type: 'address' } ],
  ...
  { constant: false,
    inputs: [],
    name: 'stakeMaxUSDCAndIssueMaxPynths',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0x27a02a8b' },
  { constant: false,
    inputs:
     [ { internalType: 'uint256',
         name: '_issueAmount',
         type: 'uint256' } ],
    name: 'stakeMaxUSDCAndIssuePynths',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0x057d4b6b' },
  { constant: false,
    inputs:
     [ { internalType: 'uint256',
         name: '_usdcStakeAmount',
         type: 'uint256' } ],
    name: 'stakeUSDCAndIssueMaxPynths',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0x415d917e' },
  { constant: false,
    inputs:
     [ { internalType: 'uint256',
         name: '_usdcStakeAmount',
       ...
       { internalType: 'uint256',
         name: '_issueAmount',
         type: 'uint256' } ],
    name: 'stakeUSDCAndIssuePynths',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0x95b80e12' },
  { constant: true,
    inputs: [],
    name: 'symbol',
    outputs: [ { internalType: 'string', name: '', type: 'string' } ],
  ...
  { constant: false,
    inputs:
     [ { internalType: 'uint256',
         name: '_usdcUnstakeAmount',
         type: 'uint256' } ],
    name: 'unstakeAndRefundUSDC',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0x503fafe4' },
  { constant: false,
    inputs: [],
    name: 'unstakeToTargetAndRefundUSDC',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0xd2e26c26' },
  { constant: true,
    inputs:
     [ { internalType: 'address', name: '_account', type: 'address' } ],
