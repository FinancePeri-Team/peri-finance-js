export default [
  ...
  },
  {
    constant: false,
    inputs: [{ internalType: 'uint256', name: 'value', type: 'uint256' }],
    name: 'appendPeriDebtLedgerValue',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0xf4bf5993',
  },
  {
    constant: true,
    inputs: [],
  ...
  },
  {
    constant: false,
    inputs: [{ internalType: 'address', name: 'account', type: 'address' }],
    name: 'clearPeriIssuanceData',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0x7a3b6ffa',
  },
  {
    constant: true,
  ...
  },
  {
    constant: false,
    inputs: [],
    name: 'decrementTotalPeriIssuerCount',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0xd4404702',
  },
  {
    constant: true,
    inputs: [{ internalType: 'address', name: 'account', type: 'address' }],
  ...
  },
  {
    constant: false,
    inputs: [],
    name: 'incrementTotalPeriIssuerCount',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0xadc63059',
  },
  {
    constant: true,
  ...
  },
  {
    constant: true,
    inputs: [],
    name: 'lastPeriDebtLedgerEntry',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
    signature: '0x0cc5fe1e',
  },
  {
    constant: false,
  ...
  },
  {
    ...
    stateMutability: 'view',
    type: 'function',
    signature: '0x7ef5099c',
  },
  {
    constant: true,
    inputs: [],
    name: 'periDebtLedgerLength',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
    signature: '0x1f912971',
  },
  {
    constant: true,
    inputs: [{ internalType: 'address', name: '', type: 'address' }],
    name: 'periIssuanceData',
    outputs: [
      {
        internalType: 'uint256',
        name: 'initialDebtOwnership',
  ...
  },
  {
    ...
    name: 'setCurrentPeriIssuanceData',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0x3ffb5001',
  },
  {
    constant: true,
    inputs: [],
  ...
  },
  {
    constant: true,
    inputs: [],
    name: 'totalPeriIssuerCount',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
    signature: '0xcb528da5',
  },
];
