export default [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'guaranteedPeriFinanceRate', type: 'uint256' },
    ],
  ...
  {
    constant: false,
    inputs: [{ name: 'pynthAmount', type: 'uint256' }, { name: 'guaranteedRate', type: 'uint256' }],
    name: 'exchangePynthsForSNXAtRate',
    outputs: [{ name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    constant: false,
    inputs: [{ name: 'pynthAmount', type: 'uint256' }],
    name: 'exchangePynthsForSNX',
    outputs: [{ name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
