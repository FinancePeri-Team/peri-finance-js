...
class Util {
   ...
   * example  (new Interface(CONTRACT_ABIS.Depot).functions.exchangeEtherForPynths()).data
   * example2 pynthInterface.functions.approve(MAINNET_ADDRESSES.Depot, utils.parseEther("2")).data;
  ...
  async getGasAndSpeedInfo() {
    // ethToPynth uses approx 80,000, pynthToHav 40,000 but approve 70,000; 100,000 is safe average
