...
import abi from '../../../lib/abis/polygon/PeriFinanceToPolygon';

/** @constructor
 * @param contractSettings {ContractSettings}
 */
function PeriFinanceToPolygon(contractSettings) {
   ...
   * @param depositData {bytes}
   * @param txParams {TxParams}
  
   **/
  this.deposit = async (_user, depositData, txParams) => {
    txParams = txParams || {};
    return await this.contract.deposit(_user, depositData, txParams);
  };
  ...
  /**
   * Transaction (consumes gas, requires signer)
   * @param _childChainManager {String<EthAddress>}
   * @param txParams {TxParams}
  
   **/
  this.setChildChainManager = async (_childChainManager, txParams) => {
    txParams = txParams || {};
    return await this.contract.setChildChainManager(_childChainManager, txParams);
  };
   ...
   **/
  this.withdraw = async (_amount, txParams) => {
    txParams = txParams || {};
    return await this.contract.withdraw(_amount, txParams);
  };
}

export default PeriFinanceToPolygon;
