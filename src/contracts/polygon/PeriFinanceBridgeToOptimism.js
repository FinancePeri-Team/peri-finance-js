...
import abi from '../../../lib/abis/polygon/PeriFinanceBridgeToOptimism';

/** @constructor
 * @param contractSettings {ContractSettings}
 */
function PeriFinanceBridgeToOptimism(contractSettings) {
  this.contractSettings = contractSettings || new ContractSettings();

  this.contract = new Contract(
    this.contractSettings.addressList['PeriFinanceBridgeToOptimism'],
    abi,
...
export default PeriFinanceBridgeToOptimism;
