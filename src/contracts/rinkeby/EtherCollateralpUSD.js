...
import abi from '../../../lib/abis/rinkeby/EtherCollateralpUSD';

/** @constructor
 * @param contractSettings {ContractSettings}
 */
function EtherCollateralpUSD(contractSettings) {
  this.contractSettings = contractSettings || new ContractSettings();

  this.contract = new Contract(
    this.contractSettings.addressList['EtherCollateralpUSD'],
    abi,
   ...
   * @returns Object
   **/
  this.accountsPynthLoans = async (address_1, uint256_1) => {
    return await this.contract.accountsPynthLoans(address_1, uint256_1);
  };
...
<br>Payable (to enter ETH amount set txParams.value)
   ...
   * @returns BigNumber
   **/
  this.totalIssuedPynths = async () => {
    return await this.contract.totalIssuedPynths();
  };
...
export default EtherCollateralpUSD;
