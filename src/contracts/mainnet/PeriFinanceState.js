...
import abi from '../../../lib/abis/mainnet/PeriFinanceState';
...
function PeriFinanceState(contractSettings) {
   ...
   * @param pUSDAmounts {uint256[]}
   * @param txParams {TxParams}
  
   **/
  this.importIssuerData = async (accounts, pUSDAmounts, txParams) => {
    txParams = txParams || {};
    return await this.contract.importIssuerData(accounts, pUSDAmounts, txParams);
  };
