...
function Exchanger(contractSettings) {
   ...
   * @returns boolean
   **/
  this.isPynthRateInvalid = async currencyKey => {
    return await this.contract.isPynthRateInvalid(currencyKey);
  };
   ...
   **/
  this.setLastExchangeRateForPynth = async (currencyKey, rate, txParams) => {
    txParams = txParams || {};
    return await this.contract.setLastExchangeRateForPynth(currencyKey, rate, txParams);
  };
   ...
   **/
  this.suspendPynthWithInvalidRate = async (currencyKey, txParams) => {
    txParams = txParams || {};
    return await this.contract.suspendPynthWithInvalidRate(currencyKey, txParams);
  };
