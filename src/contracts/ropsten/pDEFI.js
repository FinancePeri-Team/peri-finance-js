...
import abi from '../../../lib/abis/ropsten/PurgeablePynth';

/** @constructor
 * @param contractSettings {ContractSettings}
 */
function pDEFI(contractSettings) {
  this.contractSettings = contractSettings || new ContractSettings();

  this.contract = new Contract(
    this.contractSettings.addressList['ProxypDEFI'],
    abi,
   ...
   * @returns BigNumber
   **/
  this.transferablePynths = async account => {
    return await this.contract.transferablePynths(account);
  };
}

export default pDEFI;
